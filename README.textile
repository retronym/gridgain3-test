...
GridGain comes with a Monte Carlo example, see <pre>$GRIDGAIN_HOME/examples/java/org/gridgain/examples/montecarlo/CreditRiskManager.java</pre>
...
See <pre>$GRIDGAIN_HOME/examples/java/org/gridgain/examples/messaging</pre> for examples.
